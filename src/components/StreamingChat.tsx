...
export function StreamingChat({ messages, currentStreamingId }: StreamingChatProps) {
  ...
  useEffect(() => {
    // Content area is centered with max-width 800, plus padding
    const contentWidth = Math.min(Math.max(containerWidth - 64, 200), 736);
  ...
  return (
    <div
      ref={containerRef}
      className="h-full overflow-y-auto bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent"
    >
      ...
      <div className="max-w-[800px] mx-auto px-4 py-6">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-[60vh] text-gray-500">
            ...
            <p className="text-sm mt-3 text-gray-400 max-w-md text-center">
              Select councilors from the drawer and submit a motion to begin deliberation
            </p>
        ...
        <div className="space-y-6">
          {messages.map((msg) => {
            // Use pre-measured height; fallback to 80 for new messages
            ...
            return (
              ...
              >
                ...
                <div
                  className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center text-xl shadow-lg"
                  style={{
