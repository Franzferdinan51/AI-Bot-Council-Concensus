...
Copy and paste this prompt to your AI assistant (Claude, GPT-4, etc.) to help it effectively use the AI Council MCP Server:
...
1. **Copy the entire prompt above** (from "SYSTEM PROMPT FOR AI ASSISTANT:" to "insights!")

2. **Paste it into your AI assistant** (Claude, GPT-4, etc.) at the start of your conversation

3. **Reference it when needed**: When you want to use the MCP server, remind your assistant "Remember your AI Council MCP Server capabilities"

4. **Customize as needed**: Modify the prompt to emphasize features most relevant to your use case
